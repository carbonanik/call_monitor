...
void _historySerialize(
  ...
  writer.writeLong(offsets[0], object.continuation);
...
History _historyDeserialize(
  ...
  object.continuation = reader.readLong(offsets[0]);
...
extension HistoryQueryFilter
  ...
  QueryBuilder<History, History, QAfterFilterCondition> continuationEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'continuation',
        value: value,
      ));
    });
  }

  QueryBuilder<History, History, QAfterFilterCondition> continuationGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<History, History, QAfterFilterCondition> continuationLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<History, History, QAfterFilterCondition> continuationBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension HistoryQuerySortBy on QueryBuilder<History, History, QSortBy> {
  QueryBuilder<History, History, QAfterSortBy> sortByContinuation() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'continuation', Sort.asc);
    });
  }

  QueryBuilder<History, History, QAfterSortBy> sortByContinuationDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'continuation', Sort.desc);
    });
  }
...
extension HistoryQuerySortThenBy
  ...
  QueryBuilder<History, History, QAfterSortBy> thenByContinuation() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'continuation', Sort.asc);
    });
  }

  QueryBuilder<History, History, QAfterSortBy> thenByContinuationDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'continuation', Sort.desc);
    });
  }
...
extension HistoryQueryWhereDistinct
  ...
  QueryBuilder<History, History, QDistinct> distinctByContinuation() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'continuation');
    });
  }
...
extension HistoryQueryProperty
  ...
  QueryBuilder<History, int, QQueryOperations> continuationProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'continuation');
    });
  }
